  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        tips: ['Save as Draft first, then Issue when stock is physically transferred', 'Requisitioned qty is tracked separately in the Stock Summary — keep it up to date', 'Keyed a quantity wrong on an issued slip? A supervisor can reopen it with Correct Quantities, or delete it, until the month is closed — after that, only the account owner can']
      },
      {
