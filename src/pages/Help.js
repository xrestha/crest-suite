...
const POS_FEATURES = [
                ...
                },
                {
                  ...
                  tips: [
                    ...
                    'One table cannot be held for two bookings at overlapping times — the save tells you which booking already has it. Back-to-back is fine: a 6:00–7:30 booking and a 7:30 booking can share a table',
                ...
                },
                {
                  ...
                  tips: [
                    ...
                    'Before issuing, the screen asks "Was money returned to the customer?". Cash = you handed cash back from the till: it is recorded as a Refund on the open shift, so the drawer count at closing expects it (a shift must be open). Other = returned by card, QR or bank transfer: nothing comes off the drawer. None = no money went back, for example a billing mistake corrected before the customer paid',
