            ...
            <div style={{ marginBottom: 32 }}>
              ...
              {moduleOpen('pos') && (
                ...
                },
                {
                  ...
                  desc: 'Eight views of the same POS sales data, one page: Daily (day-by-day totals), Hourly (revenue by time of day), Bill Register (every individual voucher — payment mode, remarks, who closed it), Payment Summary (revenue by Cash/Card/eSewa/Khalti/FonePay/Credit), Category Wise and Item Wise (what drives revenue), Customer Wise (who\'s buying and how much), and 1L+ Report (Nepal VAT Annexure 13 — parties whose cumulative transactions exceed NPR 1,00,000 in a fiscal year). Requires Manager role or above.',
                  tips: [
                    'Daily/Hourly/Bill Register/Payment Summary/Category/Item/Customer share one BS date-range filter; 1L+ Report uses its own Fiscal Year selector instead, since Annexure 13 is a whole-year compliance check, not an arbitrary range',
