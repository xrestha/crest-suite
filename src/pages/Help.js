...
const POS_FEATURES = [
                ...
                },
                {
                  ...
                  tips: [
                    ...
                    'A new ticket chimes as it lands. If one then sits in New for more than 8 minutes with nobody pressing Start, an alert bar drops down over the board naming the oldest one and keeps chiming every 20 seconds until someone takes it, turning red past 15 minutes — the same two marks the card\'s △ and ▲ use. Mute 5 min silences the sound and leaves the bar up. It deliberately does not fire for every unstarted ticket: a kitchen working through a queue always has a few, and an alarm going off all service is one that gets muted on the first night',
