  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        tips: ['The "Items Over Tolerance" card counts items outside your configured tolerance AND worth more than NPR 500. It used to count anything that differed at all, which on a normal month was almost every item, so the number was large, permanently red, and disagreed with the handful the table below actually flagged', 'Items with both high theoretical and high actual usage → recipe portion sizes may need revision', 'Use alongside Budget vs Actual for the most complete picture']
      },
      {
