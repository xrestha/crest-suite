    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { label: 'Add missing bills →', desc: 'On a closed row: opens Purchases on THAT month (/purchases?period=<id>) so a bill missed at the time can still be entered. Closed months are already writable for admin, so this replaces reopening for the case people actually reach for it — and unlike Reopen it works while a later month is open. Regenerate that month\'s Monthly Owner Report afterwards; the snapshot was frozen at close and does not include the new bill until it is.' },
          { label: 'Reopen', desc: 'Sets a closed period back to open — which only matters for handing entry back to the CLIENT\'S own logins, since admin can already write to a closed month. No carry-forward logic re-runs; opening stock for that period already exists from when it was first created.' },
        ],
        formulas: [
