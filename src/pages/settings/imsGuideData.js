    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { label: '"Bought a pack?" line', desc: 'A calculator, not a field. Type what you actually bought — 500 GM for NPR 388.50 — and it fills Price per GM with 0.777. Neither box is saved and both clear every time you reopen the item. To record that an item ALWAYS comes in a pack, use the Conversion tab instead.' },
