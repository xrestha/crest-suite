    ...
    sections: [
      ...
      },
      {
        ...
        gotchas: [
          ...
          'Tablet keys are NOT in a client backup and are not restored: after a restore each tablet is activated again, one tap each. Archiving a client does not revoke its tablet keys yet (open item).',
    ...
    sections: [
      ...
      },
      {
        ...
        gotchas: [
          ...
          'If the check for cancelled lines fails, the board says so and keeps the cancellations it last saw — a line the kitchen was told is cancelled never quietly becomes un-cancelled. A pull made by "Clear Occupied" on the floor is not shown (open item).',
      ...
      },
      {
        ...
        gotchas: [
          ...
          'The double-booking check runs on the screen, against the bookings it has loaded. Two devices saving a booking for the same table in the same second can both succeed — rare, and an open item.',
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        gotchas: [
          ...
          'Known gap: choosing Other or None prints "(money returned by card, QR or bank)" or "(no money returned)" as part of the reason on the printed note, because the note has nowhere else to keep it.',
        ],
