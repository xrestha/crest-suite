    ...
    sections: [
      {
        ...
        fields: [
          ...
          { label: 'Where a client finds it in the sidebar', desc: 'A labelled, collapsible CREST SUITE group sits under the Dashboard link on every module panel — IMS, HR and POS alike, since Suite is cross-module. It holds EVERY Suite feature: Owner Dashboard, Owner Report, Profit & Loss, Group Console (with more than one outlet), Demand Forecast and Fixed Assets. A client without suite_plan sees the same group carrying a PRO chip in place of the item count, and the rows still click through to the in-place upsell.' },
