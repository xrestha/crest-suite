    ...
    sections: [
      {
        ...
        formulas: [
          ...
          'Labour Cost % = labour ÷ revenue × 100, where labour is the finalized Payroll Run (gross + OT + employer SSF) when one exists, otherwise the prorated estimate.',
          'Prime Cost % = Food Cost % + Labour Cost %. Benchmark 60–65% for Nepal F&B.',
          'True Net Margin % = (revenue − net purchases − labour − Overheads "overhead" bucket) ÷ revenue × 100. Tax & Fees and the Overheads Labour bucket are NOT subtracted.',
