    ...
    sections: [
      {
        ...
        connections: 'Reads Attendance, Overtime (approved, per-day supersede), Pay Setup, Advances, TADA Claims (Approved, trip ended by month end), finalized Final Settlements (to leave their month out) and finalized festival/incentive rows (the YTD tax base). HR Reports shows the run while it is still a draft (with a warning) as well as once finalized; finalized payslips feed Festival/Incentive tax projections, Self-Service payslips, and the Dashboard\'s SSF-deadline card. Salary payments feed the Staff paid step of the month strip and the "Paid on …" line in the Crest Staff app (get_my_salary_payments).',
      },
      {
