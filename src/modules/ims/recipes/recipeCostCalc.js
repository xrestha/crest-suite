...
export const EMPTY_RECIPE = { name: '', category: 'Food', recipe_code: '', selling_price: '', vat_rate: '0.13', yield_qty: '1', yield_uom: 'portion', target_fc_pct: '30', description: '', image_url: '', is_veg: '', is_build_your_own: false }
