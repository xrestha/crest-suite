  ...
  function setStatus(status) {
    ...
    askConfirm({
      ...
      body: status === 'finalized'
        ? <p style={{ margin: 0 }}>{rows.length} allowance{rows.length === 1 ? '' : 's'}, NPR {total.toLocaleString('en-IN')} in total, lock as a permanent record and stop accepting edits. This can be undone with Reopen.</p>
