  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: 36, textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 14, color: 'var(--theme-text3)', marginTop: 6 }}>
      ...
      {!selected ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 32 }}>
          ...
          <div style={{ textAlign: 'center', marginTop: 16 }}>
            <button
              onClick={deactivate}
              style={{ fontSize: 12, color: 'var(--theme-text3)', background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'underline', marginRight: 12 }}
            >
              Deactivate device
            </button>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20, width: 240 }}>
          ...
          <button
            onClick={back}
            style={{ alignSelf: 'flex-start', background: 'none', border: 'none', color: 'var(--theme-accent)', cursor: 'pointer', fontSize: 13, padding: 0 }}
          >
            ← Back
          </button>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 72px)', gap: 10 }}>
            {KEYS.flat().map((k, i) => (
              <button
                ...
                onMouseLeave={e => { if (k) e.currentTarget.style.background = 'var(--theme-card)' }}
              >
                {k}
              </button>
            ))}
